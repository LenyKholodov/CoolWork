...
template <class T,int size> template <int size1>
...
template <class T,int size>
const vec<T,size> vmin (const vec<T,size>& a,const vec<T,size>& b)
{
  return vec<T,size> (a,b,vec_min<T,size>);
}

template <class T,int size>
const vec<T,size> vmax (const vec<T,size>& a,const vec<T,size>& b)
{
