#ifndef __COOLWORK_MATHLIB_UTILS__
#define __COOLWORK_MATHLIB_UTILS__
...
template <class T> void quat2AxisAngle  (const quat<T>& q,T& angle,vec<T,3>& axis,const T& eps = EPS);
